...
class Iugu:
    """
    The Base class of IUGU SDK. Instantiate this to interface with IUGU.

    :param str token: IUGU API Token
    """
    ...
    def request(self,
        ...
        """
        This method can be used to make requests on IUGU REST API.
        """
